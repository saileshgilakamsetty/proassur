...
<script src="<?php echo base_url("assets/newTheme/assets/js/si.js?v=").$var ?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/newTheme/assets/js/mediaelement-and-player.min.js?v=").$var ?>"></script>
<script src="<?php echo base_url("assets/newTheme/assets/js/perfect-scrollbar.jquery.min.js?v=").$var ?>"></script>
<script src="<?php echo base_url("assets/newTheme/assets/js/twemoji/2/twemoji.min.js?v=").$var ?>"></script>
    ...
    $(document).ready(function () {
        ...
        function getGroupMembers(groupId) {
            ...
            let settings = {
                ...
                "contentType": false,
                "beforeSend": function () {
                    $('#groupMembers').html('<li id="loadinggroupmembers" class="text-center"><img src="<?php echo base_url('assets/img/loadingMessage.gif')?>" style="width:50px;margin-top: 20px;"></li>');
                },
                "success": function () {
