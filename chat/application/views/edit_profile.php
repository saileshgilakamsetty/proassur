                            ...
                            <div class="col-md-12 pad-1" id="basic-information">
                                ...
                                <form role="form" id="profileUpdate">
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input id="firstName" name="firstName" type="text" maxlength="15"  class="form-control profileInfo" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="lastName">Last Name</label>
                                        <input id="lastName" type="text" name="lastName" maxlength="15" class="form-control profileInfo">
                                    </div>
