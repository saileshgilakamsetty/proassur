<script src="<?php echo base_url("assets/newTheme/assets/js/vendors/jquery.min.js?v=").$var ?>"></script>
...
<script src="<?php echo base_url("assets/newTheme/assets/js/toastr.min.js?v=").$var ?>"></script>
<script src="<?php echo base_url("assets/newTheme/assets/js/anchorme.min.js?v=").$var ?>"></script>

<script src="<?php echo base_url("assets/newTheme/assets/js/magicsuggest.js?v=").$var ?>"></script>
<script src="<?php echo base_url("assets/newTheme/assets/js/moment.min.js?v=").$var ?>"></script>

<script src="<?php echo base_url("assets/newTheme/assets/js/socket.io.js?v=").$var ?>"></script>


<script src="<?php echo base_url("assets/newTheme/assets/js/jwt-decode.min.js?v=").$var ?>"></script>

<script src="<?php echo base_url("assets/newTheme/assets/js/clamp.min.js?v=").$var ?>"></script>
