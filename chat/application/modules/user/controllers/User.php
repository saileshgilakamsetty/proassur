...
class User extends REST_Controller
{
    ...
    public function changePassword_post()
    {
        if(!ID_LOGIN) {
            ...
            $id = $this->User_Model->getTokenToId($this->authToken);
        }else{
            $id=$this->post("userId");
        }
    ...
    public function friendList_get()
    {
        if(!ID_LOGIN) {
            ...
            $userId =(int) $this->User_Model->getTokenToId($this->authToken);
        }else{
    ...
    public function userProfile_get()
    {
        if(!ID_LOGIN) {
            ...
            $id =(int) $this->User_Model->getTokenToId($this->authToken);
        }else{
            $id=$this->get("userId");
        }
