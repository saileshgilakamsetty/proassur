<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small><?=getContentLanguageSelected('FRANCHISE_EDIT',defaultSelectedLanguage())?></small>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    ...
                    <div class="form-group">
                        ...
                        $warranty_name = $dataCollection->franchise_name_id;

                        echo form_dropdown('franchise_name_id',getCompanyOptions('tbl_franchise_name','Select Franchise',1),set_value('franchise_name_id',isset($warranty_name)?$warranty_name:""),$data);?>
                        <?=form_error('warranty_name_id'); ?>
                            ...
                            <?php $actual_catalogue=$dataCollection->actual_catalogue ?>

                            <input type="radio" name="fixed" id="percent_div_show" value="0"<?php if($fixed==0 && $actual_catalogue==1) { ?>  checked="checked" <?php } ?>><?=getContentLanguageSelected('ACTUAL',defaultSelectedLanguage())?>/<?=getContentLanguageSelected('CATALOGUE',defaultSelectedLanguage())?></label>
                            <?=form_error('fixed'); ?>
                            <label class="radio-inline">
                            <?php $actual_catalogue=$dataCollection->actual_catalogue ?>
                            <input type="radio" name="fixed" id="fixed_value_div_show" value="1"<?php if($actual_catalogue==0 && $fixed==1) { ?>  checked="checked" <?php } ?> ><?=getContentLanguageSelected('FIXED_VALUE',defaultSelectedLanguage())?></label>
                            <?=form_error('actual_catalogue'); ?>
                            </div>
                      ...
                      <div class="form-group">
                         ...
                         <?php $data = 'class="form-control" ';
                            ...
                            $warranty = $dataCollection->warranty_id;

                            echo form_dropdown('warranty_id',getWarrantyOptions('tbl_warranty','Select Warranty',1),set_value('warranty_id',isset($warranty)?$warranty:""),$data);?>
