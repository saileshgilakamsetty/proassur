<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <small><?=getContentLanguageSelected('DEPARTMENT_EDIT',defaultSelectedLanguage())?></small>
         ...
         <div class="col-sm-12">
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <div class="btn-group"> 
                     <a class="btn btn-primary" href="<?=base_url('admin/department/lists')?>"> <i class="fa fa-list"></i> <?=getContentLanguageSelected('DEPARTMENT_LIST',defaultSelectedLanguage())?></a>  
                  </div>
               </div>
                     ...
                     <div class="col-md-6" >
                        ...
                        <div class="form-group">
                           ...
                           <?php $data = 'class="form-control" ';
                              $region = $dataCollection->region_id;
                              
                              echo form_dropdown('region_id',getRegionOptions('tbl_region','Select Region',1),set_value('region_id',isset($region)?$region:""),$data);?>
