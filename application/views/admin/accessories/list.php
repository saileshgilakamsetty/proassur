<div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        ...
                        <small><?=getContentLanguageSelected('ACCESSORIES_LIST',defaultSelectedLanguage())?></small>
                    ...
                    <div class="row">
                        ...
                        <?php } ?>
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    ...
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="<?=base_url('admin/accessories/add')?>"> <i class="fa fa-plus"></i>  <?=getContentLanguageSelected('ADD_ACCESSORIES',defaultSelectedLanguage())?></a>  
                                    </div>
                        ...
                        <div class="panel-body">
                          ...
                          <tr >
                                   ...
                                   <td width="70"><a title="Click to Inactive" href="<?=base_url('admin/accessories/status/'.$data->id.'/0')?>"  data-toggle="tooltip" data-placement="left" class="label-default label label-success">active</a></td>
                                   <?php } else { ?>
                                   <td width="70"><a title="Click to Active" href="<?=base_url('admin/accessories/status/'.$data->id.'/1')?>"  data-toggle="tooltip" data-placement="left" class="label-default label label-danger">Inactive</a></td>
                                   <?php } ?>
                                   <td width="10%" >
                                    <a href="<?=base_url('admin/accessories/edit/'.$data->id)?>" class="label-default label label-success" data-toggle="tooltip" data-placement="left" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <a  onclick="return confirm('Sure you want to delete')" href="<?=base_url('admin/accessories/delete/'.$data->id)?>" class="label-default label label-danger" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            <?php }} ?>
