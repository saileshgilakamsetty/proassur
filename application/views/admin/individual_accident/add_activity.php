         ...
         <div class="col-sm-12">
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <div class="btn-group"> 
                     <a class="btn btn-primary" href="<?=base_url('admin/individual-accident/individual-accident-activity-list')?>"> <i class="fa fa-list"></i> <?=getContentLanguageSelected('INDIVIDUAL_ACCIDENT_ACTIVITY_LIST',defaultSelectedLanguage())?> </a>  
                  </div>
               </div>
                     ...
                     <div class="col-md-6" >
                        ...
                        <div class="form-group">
                           ...
                           <?php $data = 'class="form-control "';
                              echo form_dropdown('activity_id',getSingleOptions('tbl_activity','Select Activity',1),set_value("activity_id"),$data);?>
