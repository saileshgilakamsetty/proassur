<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <small><?=getContentLanguageSelected('ACCIDENT_INSURANCE_OPTIONS_ADD',defaultSelectedLanguage())?></small>
                     ...
                     <div class="col-md-6" >
                        ...
                        <div class="form-group">
                           <label><?=getContentLanguageSelected('ACTIVITY',defaultSelectedLanguage())?><span class="required">*</span></label>
                            <?php $data = ' class="form-control" input" onChange = "getCompanyByIndividualAccidentActivityId(this.value);" ';
                        ...
                        <div class="form-group">
                           <label><?=getContentLanguageSelected('COMPANY',defaultSelectedLanguage())?><span class="required">*</span></label>
                              <?php $data = 'class="form-control " id="company_by_individual_activity"'; 
                              echo form_dropdown('company_id',getCompanyByIndividualAccidentActivityId(set_value('individual_accident_activity_id')),set_value("company_id"),$data);?>
