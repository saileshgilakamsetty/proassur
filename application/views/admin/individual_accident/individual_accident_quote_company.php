<div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        ...
                        <small><?=getContentLanguageSelected('INDIVIDUAL_ACCIDENT_QUOTE',defaultSelectedLanguage())?></small>
                        ...
                        <div class="panel-body">      
                          <div class="table-responsive">
                           ...
                           <?php if(!empty($company_id_array)){ 
                              ...
                              ?>
                              <tr  class="select_individual_accident_company_option" individual_accident_quote_id="<?=$individual_accident_quote_id?>" value="<?=$company_id?>" >
