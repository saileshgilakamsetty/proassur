<div class="content-wrapper">
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <small><?=getContentLanguageSelected('ACCIDENT_INSURANCE_OPTIONS_EDIT',defaultSelectedLanguage())?></small>
         ...
         <div class="col-sm-12">
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <div class="btn-group"> 
                     <a class="btn btn-primary" href="<?=base_url('admin/individual-accident/accident-insurance-options')?>"> <i class="fa fa-list"></i> <?=getContentLanguageSelected('ACCIDENT_INSURANCE_OPTIONS_LIST',defaultSelectedLanguage())?></a>  
                  </div>
               </div>
                     ...
                     <div class="col-md-6" >
                        <div class="form-group">
                           <label><?=getContentLanguageSelected('ACTIVITY',defaultSelectedLanguage())?><span class="required">*</span></label>
                            <?php
                            $activity   = $dataCollection->individual_accident_activity_id; 
                            $data       = ' class="form-control" input" onChange = "getCompanyByIndividualAccidentActivityId(this.value);" ';
                              echo form_dropdown('individual_accident_activity_id',getIndividualAccidentActivityOptions('tbl_activity','Select Activity',1),set_value("individual_accident_activity_id",isset($activity)?$activity:""),$data);?>
                        ...
                        <div class="form-group">
                           <label><?=getContentLanguageSelected('COMPANY',defaultSelectedLanguage())?><span class="required">*</span></label>
                              ...
                              $data = 'class="form-control " id="company_by_individual_activity"'; 
                              echo form_dropdown('company_id',getCompanyByIndividualAccidentActivityId($activity),set_value("company_id",isset($company)?$company:""),$data);?>
