<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <small><?=getContentLanguageSelected('TRAVEL_QUOTE',defaultSelectedLanguage())?></small>
         <ol class="breadcrumb hidden-xs">
            <li><a href="<?=base_url('admin/dashboard');?>"><i class="pe-7s-home"></i> <?=getContentLanguageSelected('HOME',defaultSelectedLanguage())?></a></li>
            <li class="active"><?=getContentLanguageSelected('TRAVEL_QUOTE',defaultSelectedLanguage())?></li>
         </ol>
      </div>
   </section>
   <!-- Main content -->
         ...
         <div class="col-sm-12">
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <div class="btn-group"> 
                     <a class="btn btn-primary" href="<?=base_url('admin/travel-quote/lists')?>"> <i class="fa fa-list"></i>  <?=getContentLanguageSelected('TRAVEL_QUOTE_LIST',defaultSelectedLanguage())?></a>  
                  </div>
               </div>
                  ...
                  <form  method="post" enctype="multipart/form-data">
                     <div class="col-sm-6" >
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="area" id="area" placeholder="area" value="<?=set_value('area', isset($dataCollection->area)?$dataCollection->area:""); ?>" >
                           <?=form_error('area'); ?>
                        </div>
