         ...
         <div class="col-sm-12">
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <div class="btn-group"> 
                     <a class="btn btn-primary" href="<?=base_url('admin/travel-conditions/lists')?>"> <i class="fa fa-list"></i>  <?=getContentLanguageSelected('CONDITION_LIST',defaultSelectedLanguage())?></a>  
                  </div>
               </div>
