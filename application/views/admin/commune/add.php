<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <small><?=getContentLanguageSelected('COMMUNE_ADD',defaultSelectedLanguage())?></small>
                     ...
                     <div class="col-md-6" >
                        <div class="form-group">
                           ...
                           <?php $data = ' class="form-control input"';
                              echo form_dropdown('department_id',getDepartmentOptions('tbl_department','Select Department',1),set_value("department_id"),$data);?>
                           <?=form_error('department_id'); ?>
                        </div>
                        <div class="form-group">
                           <label><?=getContentLanguageSelected('NAME',defaultSelectedLanguage())?><span class="required">*</span></label>
                           <input type="text" class="form-control" name="name" id="name" placeholder=" Commune Name" value="<?php echo set_value('name') ?>">
                           <?=form_error('name'); ?>
                        </div>
