<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <div class="header-title">
      ...
      <small><?=getContentLanguageSelected('COMMUNE_EDIT',defaultSelectedLanguage())?></small>
      ...
      <div class="col-sm-12">
        <div class="panel panel-bd">
          <div class="panel-heading">
            <div class="btn-group"> 
              <a class="btn btn-primary" href="<?=base_url('admin/commune/lists')?>"> <i class="fa fa-list"></i> <?=getContentLanguageSelected('COMMUNE_LIST',defaultSelectedLanguage())?></a>  
            </div>
          </div>
            ...
            <form  method="post" enctype="multipart/form-data">
              <div class="col-md-6" >
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" id="name" placeholder="<?=getContentLanguageSelected('REGION_NAME',defaultSelectedLanguage())?>" value="<?=set_value('name', isset($dataCollection->name)?$dataCollection->name:""); ?>" >
                  <?=form_error('name'); ?>
                </div>
                <div class="form-group">
                  ...
                  <?php $data = 'class="form-control" ';
                    $region = $dataCollection->department_id;  
                    echo form_dropdown('department_id',getDepartmentOptions('tbl_department','Select Department',1),set_value('department_id',isset($region)?$region:""),$data);?>
