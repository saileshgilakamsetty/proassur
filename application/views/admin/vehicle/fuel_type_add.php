<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         <h1> <?=getContentLanguageSelected('ADD_FUEL_TYPE',defaultSelectedLanguage())?></h1>
         <small><?=getContentLanguageSelected('ADD_FUEL_TYPE',defaultSelectedLanguage())?></small>
         ...
         <div class="col-sm-12">
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <div class="btn-group"> 
                     <a class="btn btn-primary" href="<?=base_url('admin/vehicle/fuel-type')?>"> <i class="fa fa-list"></i> <?=getContentLanguageSelected('FUEL_TYPE_LIST',defaultSelectedLanguage())?></a>  
                  </div>
               </div>
