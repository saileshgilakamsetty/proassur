<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <small><?=getContentLanguageSelected('DESIGNATION_ADD',defaultSelectedLanguage())?></small>
                     ...
                     <div class="col-md-6" >
                                  ...
                                  <div class="form-group">
                                     ...
                                     <?php $data = ' class="form-control input" ';
                                        echo form_dropdown('vehicle_make_id',getCompanyOptions('tbl_vehicle_make','Select Vehicle Make',1),set_value("vehicle_make_id"),$data);?>
