                  ...
                  <form  method="post" enctype="multipart/form-data">
                     <div class="col-md-12" >
                        <div class="control-group">
                           ...
                           <label class="cus_radio">
                              <input type="radio" vehicle_detail_id="<?=$vehicle_detail_id?>" name="optional_warranty_want" value="1" checked="checked">Yes
                           </label>
                           <label class="cus_radio">
                              <input type="radio" vehicle_detail_id="<?=$vehicle_detail_id?>" name="optional_warranty_want" value="0" >No
                           </label>
                           <?=form_error('optional_warranty_want'); ?>
                        </div>
                     </div>                     
                     <div class="col-md-6" >
                     ...
                     foreach ($optional_warranties as $value) { ?>
                        <div class="form-group">
                         <input type="checkbox" name="optional_warranties" id="<?=$value->id?>" placeholder="Name" value="<?=$value->id?>">
