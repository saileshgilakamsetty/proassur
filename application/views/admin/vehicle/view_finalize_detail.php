            ...
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <form  method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="company_name" value="<?= getCompanyName($company_id)?>" >
                    <input type="hidden" name="policy_premium" id="policy_premium" placeholder="policy_premium" value="<?=$premium_value?>">
                    ...
                    <div class="row">
                     <div class="form-group col-md-6">
                        ...
                        <?php /*<label><?=getContentLanguageSelected('NET_PREMIUM',defaultSelectedLanguage())?> <span class="required">*</span></label>*
                        ...
                        <label><?=getContentLanguageSelected('NET_PREMIUM',defaultSelectedLanguage())?> <span class="required">*</span></label>
                           <input type="text" class="form-control" name="policy_premium" id="policy_premium" readonly placeholder="Net Premium" value="<?php  print_r($premium_value);?>">
                           <?=form_error('net_premium'); ?>
                     </div>
