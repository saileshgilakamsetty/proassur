<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <small><?=getContentLanguageSelected('VEHICLE_POLICIES',defaultSelectedLanguage())?></small>
         <ol class="breadcrumb hidden-xs">
            <li><a href="<?=base_url('admin/dashboard');?>"><i class="pe-7s-home"></i> <?=getContentLanguageSelected('HOME',defaultSelectedLanguage())?></a></li>
            <li class="active"><?=getContentLanguageSelected('VEHICLE_POLICIES',defaultSelectedLanguage())?></li>
         </ol>
      </div>
   </section>
   <!-- Main content -->
                     ...
                     <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                           ...
                           <tr >
                              ...
                              <td width="10%" >
                                 <a href="<?=base_url('admin/vehicle/vehicle-policies-edit/'.encrypt($data['policy_number']).'/'.$data['insured_id'])?>" class="label-default label label-success" data-toggle="tooltip" data-placement="left" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
								 <a href="<?=base_url('admin/vehicle/card_details/'.encrypt($data['policy_number']).'/'.$data['insured_id'])?>" class="label-default label label-warning" target="_blank" data-toggle="tooltip" data-placement="right" title="Download Insurance Card"><i class="fa fa-download" aria-hidden="true"></i></a>
                              </td>
                           </tr>
                           <?php }} else { ?>
                              <tr>
