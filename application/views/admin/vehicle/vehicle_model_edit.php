<div class="content-wrapper">
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <small><?=getContentLanguageSelected('VEHICLE_MODEL_EDIT',defaultSelectedLanguage())?></small>
         ...
         <div class="col-sm-12">
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <div class="btn-group"> 
                     <a class="btn btn-primary" href="<?=base_url('admin/vehicle/vehicle-model')?>"> <i class="fa fa-list"></i> <?=getContentLanguageSelected('VEHICLE_MODEL_LIST',defaultSelectedLanguage())?></a>
                  </div>
               </div>
