               ...
               <div class="panel-heading">
                  <form  method="post" enctype="multipart/form-data">
                    ...
                    <!--  <div class="form-group">
                        <label><?=getContentLanguageSelected('MANDATORY_WARRANTIES',defaultSelectedLanguage())?><span class="required">*</span></label>
                    ...
                    <!--  <div class="form-group">
                        <label><?=getContentLanguageSelected('EXCLUSION_OF_WARRANTIES',defaultSelectedLanguage())?><span class="required">*</span></label>
                           <input type="text" class="form-control" readonly name="optional_warranties" id="optional_warranties" placeholder="Optional Warranties" value="
                           <?php echo trim(implode(',', $warranties_name)); ?>
                           ">
                           <?=form_error('optional_warranties'); ?>
