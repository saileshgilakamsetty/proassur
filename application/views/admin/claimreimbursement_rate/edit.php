                     ...
                     <div class="col-md-6" >
                        <div class="form-group">
                         ...
                         <?php $data = ' class="form-control input" ';
                              $policy_coverage_area = $dataCollection->policy_coverage_area_id;
                            echo form_dropdown('policy_coverage_area_id',getCompanyOptions('tbl_policycoverage_area','Select Policy Coverage Area',1),set_value("policy_coverage_area_id",isset($policy_coverage_area)?$policy_coverage_area:''),$data);?>
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="name" id="name" placeholder="Claim Reimbursement Name" value="<?php echo set_value('name', isset($dataCollection->name)?$dataCollection->name:''); ?>">
                           <?=form_error('name'); ?>
                        </div>

                        <div class="form-group">
                           <label><?=getContentLanguageSelected('RATE',defaultSelectedLanguage())?><span class="required">*</span></label>
                           <input type="text" class="form-control" name="rate" id="rate" placeholder="Rate" value="<?php echo set_value('rate',isset($dataCollection->rate)?$dataCollection->rate:''); ?>" >
                           <?=form_error('rate'); ?>
                        </div>

                        <div class="form-group">
                           <label><?=getContentLanguageSelected('DESCRIPTION',defaultSelectedLanguage())?><span class="required">*</span></label>
                           <textarea class="form-control " name="description" id="description" placeholder="Description" rows="10"><?php echo set_value('description',isset($dataCollection->description)?$dataCollection->description:''); ?></textarea>
