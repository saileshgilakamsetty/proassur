                        ...
                        <form  method="post" enctype="multipart/form-data">
                            <div class="col-sm-6" >
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Content Name" value="<?= set_value('name', isset($dataCollection->name) ? $dataCollection->name : ""); ?>" onchange="this.value = getUnderscoreForSpace(this.value);" >
                            ...
                            <div class="col-sm-10">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" rows="3"><?= set_value('description', isset($dataCollection->description) ? $dataCollection->description : ""); ?></textarea>
