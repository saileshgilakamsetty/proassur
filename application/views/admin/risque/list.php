<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <div class="header-title">
      ...
      <small><?=getContentLanguageSelected('RISQUE_LIST',defaultSelectedLanguage())?></small>
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="panel panel-bd">
          <div class="panel-heading">
            <div class="btn-group"> 
              <a class="btn btn-success" href="<?=base_url('admin/risque/add')?>"> <i class="fa fa-plus"></i>  <?=getContentLanguageSelected('ADD_RISQUE',defaultSelectedLanguage())?></a>  
            </div>
            ...
            <div class="row usList">
              <div class="col-sm-4">   
                ...
                <?php
                  $data = 'class="filter_by_risquename" id="risque_name_filter"';
                  echo form_dropdown('risque_name_id', getSingleOptions('tbl_risque','Select Risque',1) ,set_value('risque_name_id', (isset($_GET['risque_name_id'])) ? $_GET['risque_name_id'] : '' ),$data); 
                ?>  
              </div>
                  ...
                  foreach ($dataCollection as $data) { ?>
                    <tr >
                      ...
                      <?php if($data->status==1){ ?>
                        <td width="80"><a title="Click to Inactive" href="<?=base_url('admin/risque/status/'.$data->id.'/0')?>"  data-toggle="tooltip" data-placement="left" class="label-default label label-success">Active</a></td>
                      <?php } else { ?>
                        <td width="80"><a title="Click to Active" href="<?=base_url('admin/risque/status/'.$data->id.'/1')?>"  data-toggle="tooltip" data-placement="left" class="label-default label label-danger">Inactive</a></td>
                      <?php } ?>
                      <td width="10%">
                        <a href="<?=base_url('admin/risque/edit/'.$data->id)?>" class="label-default label label-success" data-toggle="tooltip" data-placement="left" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                        <a  onclick="return confirm('Sure you want to delete')" href="<?=base_url('admin/risque/delete/'.$data->id)?>" class="label-default label label-danger" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                      </td>
                    </tr>
                  <?php }} ?>            
                </tbody>
