<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <small><?=getContentLanguageSelected('RISQUE_ADD',defaultSelectedLanguage())?></small>
                  ...
                  <form  method="post" enctype="multipart/form-data">
                     <div class="col-md-6" >
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="name" id="name" placeholder="Risque Name" value="<?php echo set_value('name') ?>">
                           <?=form_error('name'); ?>
                        </div>                        
