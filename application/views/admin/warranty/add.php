<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <div class="header-title">
      ...
      <small><?=getContentLanguageSelected('WARRANTY_ADD',defaultSelectedLanguage())?></small>
            ...
            <form  method="post" enctype="multipart/form-data">
              <div class="col-sm-6" >
                <div class="form-group">
                  ...
                  <?php $data = ' class="form-control input" ';
                    echo form_dropdown('warranty_name_id',getCompanyOptions('tbl_warranty_name','Select Warranty',1),set_value("warranty_name_id"),$data);?>
                ...
                <div class="percent_div" style="display: none;">
                  ...
                  <div class="form-group">
                    <label><?=getContentLanguageSelected('MIN_VALUE',defaultSelectedLanguage())?><span class="required">*</span></label>
              ...
              <div class="col-sm-6" >
                ...
                <div id="type_of_warranties_div" style="display: none;">
                  <div class="form-group">
                    ...
                    <?php $data = ' class="form-control input" ';
                      echo form_dropdown('type_of_warranties_id',getTypeOfWarrantiesOptions('Select Type Of Warranty'),set_value("type_of_warranties_id"),$data);?>
              ...
              <div class="col-sm-10" >
                <div class="form-check">
                  ...
                  <label class="radio-inline"><input type="radio" name="status" value="1" checked="checked"><?=getContentLanguageSelected('ACTIVE',defaultSelectedLanguage())?></label>
