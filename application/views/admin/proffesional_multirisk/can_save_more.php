            ...
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <form  method="post" enctype="multipart/form-data">
                    <input type="hidden" id="proffesional_multirisk_quote_id" name="proffesional_multirisk_quote_id" value=<?=$proffesional_multirisk_quote_id?> >
                    <input type="hidden" id="warranties_selected" name="warranties_selected" value=<?=implode(",",$selected_warranty_name_id)?> >
                    <input type="hidden" id="franchises_selected" name="franchises_selected" value=<?=implode(",",$selected_franchise_name_id)?> >
                  ...
                  <div class="reset-button">
                     <button class="btn btn-success" id="finalize_company_proffesional_multirisk"><?=getContentLanguageSelected('FINALIZE_COMPANY',defaultSelectedLanguage())?></button>
                  </div>    
               </div>
               <?php
                  print_r($qwerty);
