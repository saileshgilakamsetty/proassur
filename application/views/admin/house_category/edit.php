<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <small><?=getContentLanguageSelected('HOUSE_CATEGORY_EDIT',defaultSelectedLanguage())?></small>
         ...
         <div class="col-sm-12">
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <div class="btn-group"> 
                     <a class="btn btn-primary" href="<?=base_url('admin/house-category')?>"> <i class="fa fa-list"></i> <?=getContentLanguageSelected('HOUSE_CATEGORY_LIST',defaultSelectedLanguage())?></a>  
                  </div>
               </div>
                  ...
                  <form  method="post" enctype="multipart/form-data">
                     ...
                     <div class="col-md-6" >
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="name" id="name" placeholder="House Category Name" value="<?=set_value('name', isset($dataCollection->name)?$dataCollection->name:""); ?>" >
                           <?=form_error('name'); ?>
                        </div>
