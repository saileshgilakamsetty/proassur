                  ...
                  <form  method="post" enctype="multipart/form-data">
                     <div class="col-md-12" >
                        <div class="control-group">
                           ...
                           <label class="cus_radio">
                              <input type="radio" house_detail_id="<?=$house_detail_id?>" name="optional_warranty_want_house" value="1" checked="checked"><?=getContentLanguageSelected('YES',defaultSelectedLanguage())?>
                           </label>
                           <label class="cus_radio">
                              <input type="radio" house_detail_id="<?=$house_detail_id?>" name="optional_warranty_want_house" value="0" ><?=getContentLanguageSelected('NO',defaultSelectedLanguage())?>
                           </label>
                           <?=form_error('optional_warranty_want_house'); ?>
                        </div>
                     </div>                     
                     <div class="col-md-6" >
                     ...
                     foreach ($optional_warranties as $value) { ?>
                        <div class="form-group">
                         <input type="checkbox" name="optional_warranties_house" id="<?=$value->id?>" placeholder="Name" value="<?=$value->id?>">
