         ...
         <div class="col-sm-12">
            <div class="panel panel-bd">
               <div class="panel-heading">
                  <div class="btn-group"> 
                     <a class="btn btn-primary" href="<?=base_url('admin/franchise-name/lists')?>"> <i class="fa fa-list"></i><?=getContentLanguageSelected('FRANCHISE_NAME_LIST',defaultSelectedLanguage())?> </a>  
                  </div>
               </div>
                  ...
                  <form  method="post" enctype="multipart/form-data">
                     <div class="col-md-6" >
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="name" id="name" placeholder=" Franchise Name" value="<?php echo set_value('name') ?>">
                           <?=form_error('name'); ?>
                        </div>
