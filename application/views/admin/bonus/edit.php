<div class="content-wrapper">
  ...
  <section class="content-header">
      ...
      <div class="header-title">    
        ...
        <small><?=getContentLanguageSelected('BONUS_EDIT',defaultSelectedLanguage())?></small>
            ...
            <form  method="post" enctype="multipart/form-data">
              <div class="col-sm-6" >
                <div class="form-group">
                   ...
                   <?php $data = 'class="form-control " id="year" readonly disabled ';
                      $year = $dataCollection->year;
                      echo form_dropdown('year',getYearsOption(),set_value('year',isset($year)?$year:""),$data);?>
                   <?=form_error('year'); ?>
                </div>

                <div class="form-group">
                    <label><?=getContentLanguageSelected('DISCOUNT_IN',defaultSelectedLanguage())?>%<span class="required">*</span></label>
                    <input type="number" class="form-control" name="discount" id="discount" placeholder="Discount" value="<?=set_value('discount', isset($dataCollection->discount)?$dataCollection->discount:""); ?>" >
                     <?=form_error('discount'); ?>
                </div>
              </div> 
              ...
              <div class="col-sm-6" >
                ...
                <div class="form-group">
                  ...
                  <?php $data = ' class="form-control input" onChange = "getBranchByCompanyId(this.value);" readonly="true" disabled ';
                ...
                <div class="form-group">
                   ...
                   <?php $data = 'class="form-control " onChange = "getRisqueByBranchId(this.value);" id="branch_by_company" readonly="true" disabled ';
                ...
                <div class="form-group">
                   ...
                   <?php $data = 'class="form-control" id="risque_by_branch" disabled readonly="true" ';
