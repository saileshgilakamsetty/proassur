...
<div class="container">
   <div class="formFildes">
      <div class="col-xs-12">
         <h3 class="carOwner"><?=getContentLanguageSelected('YOU_CAN_SAVE_MORE',defaultSelectedLanguage())?></h3>
      </div>
      ...
      <div class="col-xs-12">
      	<div class="gerSelectAll">   
      	    <form  method="post" enctype="multipart/form-data">
                  <input type="hidden" id="house_detail_id" name="house_detail_id" value="<?=$house_detail_id?>" >
                  <input type="hidden" id="warranties_selected_house" name="warranties_selected_house" value=<?=implode(",",$selected_warranty_name_id)?> >
                  <input type="hidden" id="franchises_selected_house" name="franchises_selected_house" value=<?=implode(",",$selected_franchise_name_id)?> >
               <div class="col-md-8">
