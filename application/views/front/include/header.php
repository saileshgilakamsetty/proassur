   ...
   <div class="headTop">
      <div class="container">
         <div class="row">
            <div class="col-xs-12">
               <ul class="topContact">
                  <li><a href="#"><i class="fas fa-envelope"></i> <?=getSettings('support_email')?></a></li>
                  <li><a href="#"><i class="fas fa-phone"></i> <?=getSettings('support_contact_code')?> <?=getSettings('support_contact')?></a></li>
               </ul>
               <div class="language">
                  <ul>
   ...
   <div class="container">
      <div class="row">
         <div class="col-xs-12 col-sm-3">
            <figure class="topLogo"><a href="#"><img src="<?=base_url(); ?>/assets/front/images/logo.png" class="img-responsive"></a></figure>
         </div>
         <div class="col-xs-12 col-sm-9">
            <div id="cssmenu">
               <ul>
                  <li class="active"><a href=""><?=getContentLanguageSelected('HOME',defaultSelectedLanguage())?></a></li>
                  ...
                  <li><a href="#"><?=getContentLanguageSelected('RAISE_CLAIM',defaultSelectedLanguage())?></a></li>
                  <li><a href="#"><?=getContentLanguageSelected('CONTACT_US',defaultSelectedLanguage())?></a></li>
