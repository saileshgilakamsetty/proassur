            ...
            <div class="mngPay">
                <div class="container-fluid">
                    ...
                    <div class="totalIssue">
                        ...
                        <!-- <ul>
                            <li><figure><img src="<?php echo base_url(); ?>assets/front/images/dashbaord/health.png"></figure> 
                            <h4>8</h4><p>Health Insurance</p></li>
                            <li><figure><img src="<?php echo base_url(); ?>assets/front/images/dashbaord/travler.png"></figure> 
                            <h4>3</h4><p>Travel Insurance</p></li>
                            <li><figure><img src="<?php echo base_url(); ?>assets/front/images/dashbaord/moter.png"></figure> 
                            <h4>6</h4><p>Motor Insurance</p></li>
                            <li><figure><img src="<?php echo base_url(); ?>assets/front/images/dashbaord/home.png"></figure> 
                            <h4>3</h4><p>Property Insurance</p></li>
                        </ul> -->
                    </div>
                    <div class="totalDay">
                        ...
                        <div class="row">
                            ...
                            <?php foreach ($todays_total_pending_slips as $key => $value) { ?>
            ...
            <div class="mngPay">             
                <div class="container-fluid">
                    ...
                    <div class="searchBlock">
                        <form>
                            <input name="" type="text" placeholder="From">
                            <input name="" type="text" placeholder="To">
                            <div class="searchBar">
                        ...
                        <div class="payBox">
                            <div class="motorInsor">
                                <div class="dropdown moreOpt">
                                    <a data-toggle="dropdown" href="#"><img src="<?= base_url('/assets/front/') ?>images/threedot.png"></a>
                                    <ul class="dropdown-menu">
                                        <li><?= base_url('user/report/' . $value['insurance_type_id'] . '/' . $value['insured_id']) ?><?= getContentLanguageSelected('VIEW_QUITTANCE', defaultSelectedLanguage()) ?></a>
                                        </li>
                                        <!-- <li><a href="#"><?= getContentLanguageSelected('GET_HELP', defaultSelectedLanguage()) ?></a></li>
                                        <li><a href="#"><?= getContentLanguageSelected('VIEW_MORE', defaultSelectedLanguage()) ?></a></li> -->
                                    </ul>
    ...
    function get_slip_detail() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                policy_num = Object.values(dataJson.policy_numbers)
                var dataResult = '<div class="slipTb"><div class="col-md-3">';
                dataResult = dataResult + '<img class="img-responsive" src=' + dataJson.cheque_path + '>';
                ...
                dataResult = dataResult + dataJson.slip_name;
                dataResult = dataResult + '</p>';
                dataResult = dataResult + '</div>';
                dataResult = dataResult + '<div class="col-md-3">';
                dataResult = dataResult + '<label>';
                ...
                dataResult = dataResult + '</p>';
                for (var i = 0; i < policy_num.length; i++) {
                    dataResult = dataResult + '<p>';
                    //dataResult = dataResult + policy_num[i];
                    dataResult = dataResult + '</p>';
                }
                dataResult = dataResult + '</div>';
                dataResult = dataResult + '<div class="col-md-3">';
                ...
                dataResult = dataResult + '</label>';
                dataResult = dataResult + '<a href="front/download_file?file=' + dataJson.cheque_path + '"><i class="fa fa-download" title="Download Cheque"></i></a>';
                ...
                policy_data = Object.values(dataJson.policy_data);
