...
<div class="postWebsite">
   <h2><?=getStaticContent('POST_WEBSITE')?></h2>
...
<!--       <div class="form-group">
   ...
   <div class="col-sm-6">
      ...
      <div class="form-group">
        ...
        <input type="text" class=" form-control input " id="website_url" name="website_url" value="<?=set_value('website_url', isset($dataCollection->website_url)?$dataCollection->website_url:""); ?>" autocomplete="off" />
         <?=form_error('website_url'); ?>
      </div>      
      <div class="form-group">
         <label for="more_industries">More Industries<span class="required">*</span></label>
        <input type="text" class=" form-control input " id="more_industries" name="more_industries" value="<?=set_value('more_industries', isset($dataCollection->more_industries)?$dataCollection->more_industries:""); ?>" autocomplete="off" />
         <?=form_error('more_industries'); ?>
      </div>
<!--       <div class="form-group">
   ...
   <div class="col-md-12">
      <div class="control-group">
         ...
         <div class="upload-btn-wrapper">
           ...
           <input type="file"  id="image[]" name="image[]" multiple="true" onchange="checkPhoto(this)"/>
         </div>
