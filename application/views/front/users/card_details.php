...
<style type="text/css">
  ...
  <tbody>
    ...
    <tr>
      <td align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:14px;font-weight:600;"><strong><?= getContentLanguageSelected('DATE_OF_BIRTH', defaultSelectedLanguage());?></strong> : <?php echo date('m/d/y',strtotime($dob));?>
      </td>
    </tr>
    ...
    <tr>
      <td colspan="2" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; padding-left:4px;"><strong><?= getContentLanguageSelected('INSURANCE_REIMBURSEMENT_POLICY_RATE', defaultSelectedLanguage());?></strong> : <?php echo $card_details->insurance_reimbursement_rate."%";?>
      </td>
    </tr>
