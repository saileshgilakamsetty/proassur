    ...
    <div class="table-responsive">
        <table class="table" id="example">
            <thead>
                <tr>    
                    <th>Sr.No.</th>
                    <th><?= getContentLanguageSelected('LIST_OF_WARRANTIES', defaultSelectedLanguage()) ?> </th>
                    ...
                    <th><?= getContentLanguageSelected('ADMIN_IDENTIFICATION_BROOKER', defaultSelectedLanguage()) ?> </th>
                </tr>
            </thead>
        </table>
    </div>
    ...
    $(document).ready(function () {
        ...
        function fill_datatable(insurance_type_id = '', start_date='', end_date='') {
            mytable = $('#example').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('user/company_insurance_settingsList') ?>",
                    "type": "POST",
                    data: {
