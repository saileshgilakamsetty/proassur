...
class Hospitalizationmodel extends CI_Model {
	...
	private function _get_datatables_query() {
        ...
        $this->column_order = array('a.id','a.policy_holder_name_id', 'a.policy_number', 'a.the_patient_name', 'a.healthcareprovider_name_id','a.approved_status' ,'a.company_document', 'CONCAT(c.first_name, " ", c.last_name) as user_name','d.name as healthcareprovidername','e.name as company_name');
